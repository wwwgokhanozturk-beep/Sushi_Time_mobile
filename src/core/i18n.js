...
const en = {
  ...
  delivery_min_banner: 'Minimum order for {{district}}: {{min}} ₺',
...
const ru = {
  ...
  delivery_min_banner: 'Минимальный заказ для района {{district}}: {{min}} ₺',
...
const tr = {
  ...
  delivery_min_banner: '{{district}} için minimum sipariş: {{min}} ₺',
